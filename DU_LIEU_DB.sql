...
(3, 'Tiem Nang', 'Hang Moi Bat Dau', 0, 1),
(4, 'Bac', 'Thang Bac Cap 2', 100, 1),
(5, 'Vang', 'Thang Bac Cap 3', 500, 1),
(6, 'Bach Kim', 'Thang Bac Cap 4', 1000, 1),
(7, 'Than Thiet', 'Thang Bac Cap 5', 2000, 1)
go
...
(3, 'Bui Duc Minh', '2003-03-09', 'Ha Noi', '2345678901', 'minhbdph24887@fpt.edu.vn', 1, '234567890', '234567890', null, 1, 34, 3, null),
(4, 'Ngyen Van A', '2003-05-29', 'Ha Noi', '1345678902', 'anguyenvan12@fpt.edu.vn', 1, '134567890', '134567890', null, 1, 143, 4, null),
(5, 'Trinh Thi B', '2003-04-10', 'Ha Noi', '1245678903', 'btrinhthi23@fpt.edu.vn', 0, '124567890', '124567890', null, 1, 534, 5, null),
(6, 'Hoang Duc C', '2003-08-15', 'Ha Noi', '1235678904', 'choangduc34@fpt.edu.vn', 1, '123567890', '123567890', null, 0, 1034, 6, null),
(7, 'Nong Thi B', '2003-07-15', 'Ha Noi', '1234678905', 'bnongthi45@fpt.edu.vn', 0, '123467890', '123467890', null, 1, 3034, 7, null)
go
...
(1, 'Ao Thun', 'Vai', 169.000, 459, 'Hang Moi Ve', 'Hang Ao', 'Mau Vang', 'Adidas', 1),
(2, 'Dien Thoai 10', 'Thiet Bi', 1169.000, 109, 'Hang Moi Ve', 'Hang Thiet Bi', 'Mau Den', 'SamSung', 1),
(3, 'May Tinh 13', 'Thiet Bi', 2169.000, 379, 'Hang Moi Ve', 'Hang Thiet Bi', 'Mau Xanh', 'LG', 1),
(4, 'Tivi 14', 'Thiet Bi', 13269.000, 499, 'Hang Moi Ve', 'Hang Thiet Bi', 'Mau Den', 'SamSung', 1),
(5, 'Table 18', 'Thiet Bi', 15669.000, 859, 'Hang Moi Ve', 'Hang Thiet Bi', 'Mau Trang', 'Xiaomi', 1)
go

select * from HoaDon
select * from KhachHang -- Xem Lai DB KhachHang
insert into HoaDon values
(1, getDate(), 'Bui Duc Minh', 'Khong Co', getDate() + 3, 1, 3),
(2, getDate(), 'Nguyen Van A', 'Khong Co', getDate() + 3, 1, 4),
(3, getDate(), 'Trinh Thi B', 'Khong Co', getDate() + 3, 1, 5),
(4, getDate(), 'Hoang Duc C', 'Khong Co', getDate() + 3, 1, 6),
(5, getDate(), 'Nong Thi B', 'Khong Co', getDate() + 3, 1, 7)
go
...
('429656B6-038D-478D-82B6-31A43C309785', getDate(), getDate() + 1, 3, 'Khong Co', 1),
('761E2687-BDA4-4A24-A307-6A2FC9C87B29', getDate(), getDate() + 1, 4, 'Khong Co', 1),
('3AB7E2D2-CB9A-4241-AE40-71FE4F435867', getDate(), getDate() + 1, 5, 'Khong Co', 1),
('051C68B1-3149-47D7-9F42-7C5427D9DA62', getDate(), getDate() + 1, 6, 'Khong Co', 1),
('BA564EE3-ADEA-4EA6-B4A0-DFD1EBCDB5D7', getDate(), getDate() + 1, 7, 'Khong Co', 1)
go
...
('2FEC233B-F318-4DAE-BED8-12B72BC2EF2E', getDate(), getDate() + 1, 3, 'Khong Co', 1),
('474A243E-A78E-446B-98E3-D0D85FECB373', getDate(), getDate() + 1, 4, 'Khong Co', 1),
('BEDBEDA0-3351-4A2E-B2EC-E327A0B81CC8', getDate(), getDate() + 1, 5, 'Khong Co', 1),
('C20C4C8E-E54F-4E46-AEF7-EB7EC05ACA15', getDate(), getDate() + 1, 6, 'Khong Co', 1),
('4F2E1930-59D3-4478-B15C-F82CB05829A8', getDate(), getDate() + 1, 7, 'Khong Co', 1)
go
